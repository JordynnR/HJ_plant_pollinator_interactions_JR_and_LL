...
## 4. Conclusion: (discussion kind of too?- "connect to relevant comparative literature")
  ...
  With respect to pollinator competition, analysing both plots (figures 4 and 5), we can see a slight increase in native pollinator abundance with non-native pollinator presence. This goes against our predictions, and may suggest that flora is abundant enough to meet the demands of both native and non-native pollinators up in high elevation meadows. From this data of pollinator visitation, it does not suggest that non-native bees are displacing or out competing native bees. It is important to reiterate there were only 4 non-native plants present in this data set, which are shown by the orange line. 3 out of 4 non-native plant species had native pollinator abundances below the smoothed line of the native plants, displaying a smaller range of pollinator abundances. 
  As shown in figure 5, our results suggest that interactions of native pollinators with native vs. non-native plants stay relatively consistent over the growing season. A much higher proportion of native pollinators were observed at native plants compared to non-native plants. Peak observations on non-native plants were observed in the month of august, which coincides with a dip in the proportion of native pollinator observations on native plants. This may suggest that despite the lower number of non-native plants in this data, they have somewhat of an impact on the proportion of pollinator visitations. A reason for this could be that non-native plants reach peak reward later in the season, for example more pollinator attraction to peak nectar and pollen. 
