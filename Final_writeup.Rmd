...
all_species_network
```
Figure 1. Interaction network of all pollinator and plant species present in the HJ Andrews dataset, grouped by native status. Pollinators are on the left and plants are on the right. Native species are darker blue and non-native species are lighter blue.
...
native_network
```
Figure 2. Simplified interaction network of grouped pollinator and plant species by native status. Pollinators are on the left and plants are on the right. Native species are darker blue and non-native species are lighter blue.
...
test_hist
```
Figure 3. Distribution of test statistics after running AB simulation 1000 times. Observed statistic is included as a red dot for comparison.
